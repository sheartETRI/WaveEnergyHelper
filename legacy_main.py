# legacy_main.py — 11차 위임 전(前) main.py 원본 보존본 (v1 45패널 직접 조립 구조).
# 참조용 스냅샷. 새 구조(main.py 3탭 + display.panel_registry)가 문제 없음을 확인하면
# 다음 라운드에서 삭제 예정(삭제는 11차 범위 아님). 실행 진입점은 main.py.
